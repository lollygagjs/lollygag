...
const build_1 = __importDefault(require("./helpers/build"));
__exportStar(require("./helpers/general"), exports);
class Lollygag {
    constructor(__config = {
        ...
        this.handleTemplating = (_a = this._config.templatingHandler) !== null && _a !== void 0 ? _a : general_1.handleHandlebars;
