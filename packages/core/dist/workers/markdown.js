...
function markdown(options) {
    return function markdownWorker(files, lollygag) {
        ...
        if (!files)
            return;
        const { newExtname = '.html', targetExtnames = ['.md', '.html'], templatingHandler = (_a = lollygag._config.templatingHandler) !== null && _a !== void 0 ? _a : __1.handleHandlebars, markdownOptions, templatingHandlerOptions, } = options !== null && options !== void 0 ? options : {};
